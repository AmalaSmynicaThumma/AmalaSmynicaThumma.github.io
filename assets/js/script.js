...
document.addEventListener('DOMContentLoaded', function () {
  ...
  projectItems.forEach(item => {
      item.addEventListener('click', function () {
          ...
          const projectDesc = this.querySelector('.project-description').innerHTML;

          modal.style.display = "flex"; // Use flex to apply the flexbox properties
          modalImg.src = projectImg;
          modalDesc.innerHTML = projectDesc;
      });
  });
